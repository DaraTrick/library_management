                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('delete_book',$book->id) }}" class="btn btn-warning" style="margin:5px 0;"><span class="mdi mdi-delete"></span></a>
                                                        <a href="{{ route('force_delete_book',$book->id) }}" onclick="return confirm('​តើអ្នកពិតជាចង់លុបទិន្នន័យនេះ?')" class="btn btn-danger" style="margin:5px 0;"><span class="mdi mdi-delete-empty"></span></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
