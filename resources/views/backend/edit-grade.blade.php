                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="card">
                                    <div class="card-body">
                                        <form action="{{ route('update_grade',$grade_detail[0]->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group row">
                                                <label class="col-md-12 col-form-label">ឆ្នាំទី</label>
                                                <div class="col-md-12">
                                                    <input name="grade" class="form-control" type="text" placeholder="បញ្ជូលឆ្នាំទី" value="{{ $grade_detail[0]->grade }}">
                                                    @error('grade')
