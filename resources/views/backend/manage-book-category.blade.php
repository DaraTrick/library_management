                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="card">
                                    <div class="card-body">
                                        <form action="{{ route('store_book_category') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group row">
                                                <label class="col-md-12 col-form-label">ប្រភេទសៀវភៅ</label>
                                                <div class="col-md-12">
                                                    <input name="book_category" class="form-control" type="text" placeholder="បញ្ជូលប្រភេទសៀវភៅ" value="{{ old('book_category') }}">
                                                    @error('book_author')
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                @foreach( $bookCategories as $bCategory)
                                                    <tr>
                                                        <td>{{ $bCategory->book_category }}</td>
                                                        <td>
                                                            <a href="{{ route('edit_book_category',$bCategory->id) }}" class="btn btn-info"><span class="mdi mdi-pencil"></a>
                                                            <a href="{{ route('delete_book_category',$bCategory->id) }}" onclick="return confirm('តើអ្នកពិតជាចង់លុបទិន្នន័យនេះមែនឬទេ?')" class="btn btn-danger"><span class="mdi mdi-delete"></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
